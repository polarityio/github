# Polarity Github Integration

The Polarity - Github integration uses the Google search API to search for publicly available information on github from indicators to code.
